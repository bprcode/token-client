...
export function CreationPicker() {
  ...
  return (
    ...
    >
      ...
      {/* Show color icon, or selector for custom events. */}
      {type !== 'Default' && <div
        style={{
      ...
      {type === 'Default' && <><FormControl variant="standard" sx={{mr: rightMargin}}>
          ...
          {palette.map((c,i) => (
            <MenuItem
              ...
              sx={{
                ...
                borderBottomLeftRadius: i === palette.length-1 ? '8px' : '0',
                borderBottomRightRadius: i === palette.length-1 ? '8px' : '0',
                mb: 0,
              },
